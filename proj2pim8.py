...
class orangehrm():
    def test(self):
        ...
        # Clicking add button
        add_buttons = driver.find_element(By.XPATH,'//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/div/button')
        add_buttons.click()

        # Entering dependent name
        dependent_name = driver.find_element(By.XPATH,'//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[1]/div/div[1]/div/div[2]/input')
