...
class orangehrm():
    def test(self):
        ...
        # Entering name
        name = driver.find_element(By.XPATH,'//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[1]/div/div[1]/div/div[2]/input')
        name.send_keys("Balaji")

        # Entering relationship
        relationship = driver.find_element(By.XPATH,'//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[1]/div/div[2]/div/div[2]/input')
        ...
        mobile_number.send_keys("9876543208")
